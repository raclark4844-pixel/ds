    ...
    <footer className="mt-20 border-t border-line bg-surface">
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-12">
        <div className="lg:col-span-5">
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted">
            {SITE_NAME} builds custom AI-assisted digital marketing and lead-generation platforms
            connecting websites, ecommerce, SEO, GEO, AEO, CRO, content, analytics, lead capture,
            and automation. Every service is also available à la carte. Based in Mentor, Ohio and
          ...
          <p className="mt-4 text-sm text-muted">
            ...
            <Link
              to="/contact"
              className="underline decoration-line underline-offset-4 hover:text-volt"
            >
              project brief
            </Link>
            .
      ...
      <div className="border-t border-line">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 text-xs text-faint sm:flex-row sm:items-center sm:justify-between sm:px-6">
          <p>
            © {new Date().getFullYear()} {SITE_NAME}. Rankings, AI citations, traffic, lead volume,
            engagement, and conversion lifts are not guaranteed.
          </p>
        </div>
      </div>
    </footer>
